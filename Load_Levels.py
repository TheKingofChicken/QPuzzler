...
class levelloader():
    ...
    def setup_levels(self):
        ...
        level2_qbit1.set_state(0, 1, 0, 0)
        level2_qbit2 = cl.Quantum_Bit()
        level2_qbit2.set_state(1, 0, 0, 0)
        level2_goaltext = "Flip the value of a qubit using the value of another qubit"

        # Initialize level
        level2_ogfile = cl.Level([level2_qbit1, level2_qbit2], self.base_Gates, level2_goaltext, "Level 2")
        
        level2_input1 = cl.Quantum_Bit()
        level2_input1.set_state(1, 0, 0, 0)
        level2_track1 = cl.Track(level2_ogfile, 0, level2_input1)
        level2_ogfile.add_track(level2_track1)
        level2_input2 = cl.Quantum_Bit()
        level2_input2.set_state(0, 1, 0, 0)
        level2_track2 = cl.Track(level2_ogfile, 0, level2_input2)
        level2_ogfile.add_track(level2_track2)
        ...
        level3_qbit1.set_state(0, 1, 0, 0)
        level3_qbit2 = cl.Quantum_Bit()
        level3_qbit2.set_state(1, 0, 0, 0)
        level3_goaltext = "Change the position of a qubit"

        # Initialize level
        level3_ogfile = cl.Level([level3_qbit1, level3_qbit2], self.base_Gates, level3_goaltext, "Level 3")
        ...
        level3_input2 = cl.Quantum_Bit()
        level3_input2.set_state(1, 0, 0, 0)
        level3_track2 = cl.Track(level3_ogfile, 0, level3_input2)
        ...
        level4_qbit1.set_state(0, 1, 0, 0)
        level4_qbit2 = cl.Quantum_Bit()
        level4_qbit2.set_state(1, 0, 0, 0)
        level4_goaltext = "Change the position of a qubit"

        # Initialize level
        level4_ogfile = cl.Level([], self.base_Gates, level4_goaltext, "Level 4")
        
        level4_input1 = cl.Quantum_Bit()
        level4_input1.set_state(1, 0, 0, 0)
        level4_track1 = cl.Track(level4_ogfile, 0, level4_input1)
        level4_ogfile.add_track(level4_track1)
        level4_input2 = cl.Quantum_Bit()
        level4_input2.set_state(1, 0, 0, 0)
        level4_track2 = cl.Track(level4_ogfile, 0, level4_input2)
        level4_ogfile.add_track(level4_track2)
        ...
        level6_qbit1.set_state(0, 1, 0, 0)
        level6_qbit2 = cl.Quantum_Bit()
        level6_qbit2.set_state(1, 0, 0, 0)
        level6_goaltext = "Change the position of a qubit"

        # Initialize level
        level6_ogfile = cl.Level([], self.base_Gates, level6_goaltext, "Level 6")
        ...
        level7_goaltext = "Change the position of a qubit"

        # Initialize level
        level7_ogfile = cl.Level([], self.base_Gates, level7_goaltext, "Level 7")
        ...
        level8_qbit1.set_state(0, 1, 0, 0)
        level8_qbit2 = cl.Quantum_Bit()
        level8_qbit2.set_state(1, 0, 0, 0)
        level8_goaltext = "Change the position of a qubit"

        # Initialize level
        level8_ogfile = cl.Level([], self.base_Gates, level8_goaltext, "Level 8")
